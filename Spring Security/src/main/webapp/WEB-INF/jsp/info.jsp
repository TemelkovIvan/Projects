...
<style type="text/css">
    ...
    <body>
        <div>
            ...
            <p>Това е първият му проект със Spring Boot и Spring Security</p>
            ...
            <p>Проектът има следните функционалности:
                <ul>
                    ...
                    <li>&diams;&emsp;Паролите са кодирани чрез BCrypt</li>
                    <li>&diams;&emsp;За вход се изисква оторизация чрез Spring Security с Потребителско име и парола, които се проверяват в база данни</li>
                    ...
                    <li>&diams;&emsp;Всеки потребител има възможност да управлява списъкът си с обучения - да добавя и променя</li>
                    <li>&diams;&emsp;Само потребител с администраторски права има възможност изтрива от списъкът с обучения</li>
