...
public class ExporterPDF {
    ...
    public static final String fontCyrillic = "FreeSans.ttf";
    ...
    public static void exporter(SimpleNameTableModel tableModel) {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("PDF-" + currentDateTime + ".pdf"));
            document.open();
            ...
            Paragraph p = new Paragraph("Таблица", font);
    ...
    private static void writeTableData(PdfPTable table, SimpleNameTableModel tableModel) {
        ...
        for (int i = 0; i < tableModel.getRowCount(); i++) {
            for (int j = 0; j < tableModel.getColumnCount(); j++) {
                table.addCell(new Phrase(String.valueOf(tableModel.getValueAt(i,j)),font));
            }
        }
